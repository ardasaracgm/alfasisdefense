...
const T = {
  en: {
    ...
    "clients.tag": "TRUSTED BY GOVERNMENT & DEFENSE INSTITUTIONS",
    "alfauav.tag": "VTOL Airborne ISR & Electronic Warfare Platform",
    "alfauav.desc": "A mission-adaptive VTOL unmanned aerial system built for ISR, airborne electronic warfare, and high-value tactical overwatch. Combines vertical take-off and landing with efficient fixed-wing forward flight — enabling runway-independent deployment and long-endurance airborne operations in any terrain.",
    "alfauav.s1": "Mission Endurance",
    "alfauav.s2": "No Runway Required",
    "alfauav.s3": "Airborne Jamming",
    "alfauav.s4": "Persistent Overwatch",
    "alfauav.f1.title": "VTOL + Fixed-Wing Efficiency",
    "alfauav.f1.desc": "Vertical take-off and landing combined with efficient forward flight for runway-independent deployment from any terrain, ship deck, or vehicle platform.",
    "alfauav.f2.title": "Airborne Electronic Warfare",
    "alfauav.f2.desc": "Carries electronic warfare payloads for airborne jamming, RF suppression, and signal intelligence collection during extended overwatch missions.",
    "alfauav.f3.title": "Extended Mission Endurance",
    "alfauav.f3.desc": "Up to 8 hours of continuous operation for persistent ISR, tactical overwatch, and mission continuity in high-value operational environments.",
    "alfauav.cta1": "Request Technical Brief",
    "alfauav.cta2": "WhatsApp",
  ...
  ar: {
    ...
    "clients.tag": "موثوق به من قبل المؤسسات الحكومية والدفاعية",
    "alfauav.tag": "النظام الرائد",
    "alfauav.sub": "منصة VTOL للاستطلاع والحرب الإلكترونية الجوية",
    "alfauav.desc": "نظام جوي بدون طيار متكيف مع المهام، مبني للاستطلاع والحرب الإلكترونية الجوية والمراقبة التكتيكية. يجمع بين الإقلاع والهبوط العمودي والطيران الأمامي الفعال — مما يتيح النشر المستقل عن المدرج والعمليات الجوية طويلة المدة في أي تضاريس.",
    "alfauav.s1": "مدة المهمة",
    "alfauav.s2": "لا يحتاج مدرجاً",
    "alfauav.s3": "تشويش جوي",
    "alfauav.s4": "مراقبة مستمرة",
    "alfauav.f1.title": "VTOL + كفاءة الجناح الثابت",
    "alfauav.f1.desc": "الإقلاع والهبوط العمودي مع الطيران الأمامي الفعال للنشر المستقل عن المدرج من أي تضاريس أو سطح سفينة أو منصة مركبة.",
    "alfauav.f2.title": "الحرب الإلكترونية الجوية",
    "alfauav.f2.desc": "تحمل حمولات حرب إلكترونية للتشويش الجوي وكبت RF وجمع استخبارات الإشارات خلال مهام المراقبة الممتدة.",
    "alfauav.f3.title": "مدة مهمة ممتدة",
    "alfauav.f3.desc": "ما يصل إلى 8 ساعات من التشغيل المستمر للاستطلاع المستمر والمراقبة التكتيكية واستمرارية المهام.",
    "alfauav.cta1": "طلب موجز تقني",
    "alfauav.cta2": "واتساب",
  ...
  ru: {
    ...
    "clients.tag": "ДОВЕРЯЮТ ГОСУДАРСТВЕННЫЕ И ОБОРОННЫЕ СТРУКТУРЫ",
    "alfauav.tag": "ФЛАГМАНСКАЯ СИСТЕМА",
    "alfauav.sub": "Воздушная платформа VTOL для ISR и РЭБ",
    "alfauav.desc": "Миссионно-адаптивная БПЛА-система VTOL для ISR, воздушной радиоэлектронной борьбы и тактического наблюдения. Сочетает вертикальный взлёт и посадку с эффективным горизонтальным полётом — обеспечивая развёртывание без взлётной полосы в любой местности.",
    "alfauav.s1": "Продолжительность миссии",
    "alfauav.s2": "Без взлётной полосы",
    "alfauav.s3": "Воздушное подавление",
    "alfauav.s4": "Постоянное наблюдение",
    "alfauav.f1.title": "VTOL + Эффективность самолётного крыла",
    "alfauav.f1.desc": "Вертикальный взлёт и посадка с эффективным горизонтальным полётом для развёртывания без взлётной полосы с любой местности, палубы корабля или платформы.",
    "alfauav.f2.title": "Воздушная радиоэлектронная борьба",
    "alfauav.f2.desc": "Несёт полезные нагрузки РЭБ для воздушного подавления, блокировки RF и сбора разведывательных данных во время длительных миссий наблюдения.",
    "alfauav.f3.title": "Расширенная продолжительность миссии",
    "alfauav.f3.desc": "До 8 часов непрерывной работы для постоянного ISR, тактического наблюдения и непрерывности миссии в высокоценных оперативных средах.",
    "alfauav.cta1": "Запросить технический брифинг",
    "alfauav.cta2": "WhatsApp",
